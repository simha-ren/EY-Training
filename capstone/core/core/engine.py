...
from . import guardrails, suggest
from .config import DomainConfig, llm_settings, load_domains
from .generation import Answer, compose
from .ingestion import Chunk, ingest_upload, load_seed_corpus
...
class Engine:
    ...
    def ask(self, query: str, pinned: Optional[str] = None,
        ...
        answer.text = guardrails.redact_pii(cfg, answer.text)
